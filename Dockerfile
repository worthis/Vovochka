...
RUN wget -O /tmp/raylib-win.tar.gz https://github.com/raysan5/raylib/archive/caadb48e259028233515777a3e6402040c497309.tar.gz && \
    tar -xzf /tmp/raylib-win.tar.gz -C /tmp && \
    mv /tmp/raylib-caadb48e259028233515777a3e6402040c497309 /tmp/raylib-win && \
    ...
    rm -rf /tmp/raylib-win /tmp/raylib-win.tar.gz

# 4. Raylib для Switch (luizpestana/raylib-nx, 6.1-dev)
RUN wget -O /tmp/raylib-nx.tar.gz https://github.com/luizpestana/raylib-nx/archive/3afaa5a1fb5f690e66e0783f45455a8d93be54b6.tar.gz && \
    tar -xzf /tmp/raylib-nx.tar.gz -C /tmp && \
    mv /tmp/raylib-nx-3afaa5a1fb5f690e66e0783f45455a8d93be54b6 /tmp/raylib-nx && \
    ...
    rm -rf /tmp/raylib-nx /tmp/raylib-nx.tar.gz
